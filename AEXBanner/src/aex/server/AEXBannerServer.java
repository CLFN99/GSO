...
public class AEXBannerServer {
    ...
    public static void main(String[] args) {
        ...
        // Create server
        AEXBannerServer server = new AEXBannerServer();
    }

    public AEXBannerServer() {
        ...
        try {
            ...
            System.out.println("Server: Cannot create stockExchange");
        ...
        try {
            ...
            System.out.println("Server: Cannot bind stockExchange");
            System.out.println("Server: RemoteException: " + ex.getMessage());
        }
    }
